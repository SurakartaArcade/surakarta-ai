...
import { NegamaxContext, createContext, createInheritedContext } from './NegamaxContext'

const surakartaPool: Array<SK.Surakarta> = []

/**
 * @param {NegamaxContext} context
 * @returns {Array}
 */
function aggregate (context: NegamaxContext): object[] {
 ...
 */
function negamax (context: NegamaxContext): SK.Move | number {
